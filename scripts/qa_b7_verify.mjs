...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  ⚠️  B8 后勿执行，口径已改人日，请跑 qa_b8_verify.mjs  ⚠️                 ║
 * ║  本脚本为 B7 交付关卡的历史回归（effortHours 小时口径），B8 起工时登记     ║
 * ║  已改为「日志提交时登记人日并累计」（week_actual_days / effort_hours 语义  ║
 * ║  =累计实际工时·人日）。在新 schema（v5）下运行本脚本会产生大量假失败/      ║
 * ║  假阳性断言，属预期行为，非源码缺陷。请使用 B8 专项验证 qa_b8_verify.mjs。  ║
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
